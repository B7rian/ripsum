...
void UserInput::ParseCommandline(int argc,
    ...
    // Options stolen from sha256sum and md5sum man
    // pages
    static struct option long_options[] = {
        //		{"binary", no_argument, &mBinaryFlag,
        // 1},
        ...
        //&mIgnoreMissingFlag, 1},
        //		{"quiet", no_argument, &mQuietFlag, 1},
        //		{"status", no_argument, &mStatusFlag,
        // 1},
        //		{"strict", no_argument, &mStrictFlag,
        // 1},
    ...
    if (mHelpFlag) {
        ...
        std::cerr << "Block size (-s) needs to be "
                     "greater than 0\n";
        mOut.UserNeedsHelp();
    } else {
        while (optind < argc) {
