...
// AddTask is thread safe.  Put stuff at the back of
// the vector rather than the front so it doesn't have
// to move everything done.  This will trigger
...
// Empty is thread safe too, but remember that a Worker
